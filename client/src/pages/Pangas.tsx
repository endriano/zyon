...
export default function Pangas() {
  const { t } = useLanguage();
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              {t('boats.panga.description')}. Embarcaciones tradicionales que combinan 
              la funcionalidad clásica con las mejores tecnologías modernas.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div 
                ...
                data-testid={`panga-placeholder-${item}`}
              >
                ...
                <h3 className="text-xl font-semibold mb-2 text-zyon-gray dark:text-white">
                  Panga Tradicional {item}
                </h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Descripción del modelo de panga disponible.
                </p>
      ...
      <section className="py-20 bg-zyon-orange">
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Tradición y calidad en cada panga
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Descubre nuestras pangas tradicionales, perfectas para la pesca costera y recreativa.
          </p>
          <Button 
            onClick={goBack}
            variant="outline"

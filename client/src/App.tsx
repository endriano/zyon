        ...
        <LanguageProvider>
          <TooltipProvider>
            <Helmet>
              ...
              <meta
                name="keywords"
                content="embarcaciones profesionales, lanchas rápidas, pangas, embarcaciones trabajo, venta barcos, mantenimiento náutico, Galicia, Vigo"
              />
              <meta
                property="og:title"
                content="Zyon Galicia - Embarcaciones Profesionales"
              />
              <meta

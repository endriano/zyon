...
export const boatModels: BoatModel[] = [
  ...
  },
  {
    ...
    year: 2024,
    image: workboat1,
    gallery: [workboat1, workboat2, workboat3, workboat4, workboat5, workboat6],
    description: {
  ...
  },*/
  {
    ...
    features: {
      items: [
        ...
        {
          icon: "Compass",
          es: "Sistema de radares y comunicación radial avanzada",
          en: "Radar system and advanced radio communication",
          fr: "Système de radars et communication radio avancée",
        },
        {
          icon: "Gauge",
          es: "Velocidad máxima 30 nudos",
  ...
  },
  {
    ...
    features: {
      items: [
        {
          icon: "Zap",
          es: "Motores gemelos Suzuki DF200 (200 CV)",
          en: "Twin Suzuki DF200 engines (200 HP)",
          fr: "Moteurs jumeaux Suzuki DF200 (200 CH)",
        },
        {
          icon: "Compass",
          es: "Sistema de radares y comunicación radial avanzada",
        ...
        {
          icon: "Gauge",
          es: "Velocidad máxima 35 nudos",
          en: "Maximum speed 35 knots",
          fr: "Vitesse maximale 35 nœuds",
        },
      ],
    },
    specifications: {
      es: {
        ...
        Manga: "2.70 m",
        "Manga máxima": "3.00 m",
        Motorización: "2xSuzuki DF200(200 CV)",
        "Velocidad máxima": "35 nudos",
        Equipamiento: "Radial avanzado",
      },
      en: {
        "Total length": "7.50 m",
        Beam: "2.70 m",
        "Maximum beam": "3.00 m",
        Engine: "2xSuzuki DF200(200 HP)",
        "Maximum Speed": "35 knots",
        Hull: "Polyethylene- HWU",
        Equipment: "Advanced radio",
      },
      fr: {
        "Longueur totale": "7,50 m",
        Largeur: "2,70 m",
        "Largeur maximale": "3,00 m",
        Motorisation: "2xSuzuki DF200(200 CH)",
        "Vitesse Maximale": "35 nœuds",
        Équipement: "Radio avancée",
      },
    },
  },
  {
